            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="@if(isset($record)){{ route('admin_artical-update', array('id' => Crypt::encrypt($record->id))) }}@else{{route('admin_artical-store')}}@endif" id="artical-form" enctype="multipart/form-data" data-parsley-validate="">
                            ...
                            <div class="form-row">
                                        ...
                                        <div class="profile-icon">
                                            ...
                                            @if(isset($record->image))
                                                ...
                                                @if($record->image !='')
                                                    ...
                                                    <img class='img-responsive previewImage img-fluid' id="uploadPreview{{$i}}" src="{{url('public/uploads/artical/'.$record->image)}}"  alt=''>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <label for="name">{{__('Auhtor Name')}}<span class="text-danger">*</span></label>

                                    <input type="text" class="form-control" id="author_name" name="author_name" placeholder="{{__('Author Name')}}" maxlength="30" required=""  data-parsley-required-message="{{ __("This value is required.")}}" value="{{ isset($record->author_name) ? $record->author_name : old('author_name') }}">
                                        ...
                                        <div class="profile-icon">
                                            ...
                                            @if(isset($record->author_image))
                                                ...
                                                @if($record->author_image !='')
                                                    ...
                                                    <img class='img-responsive previewImage img-fluid' id="uploadPreview{{$i}}" src="{{url('public/uploads/artical/'.$record->author_image)}}"  alt=''>
                            ...
                            <a href="{{route('admin_articals')}}" class="btn btn-danger">{{__('Cancel')}}</a>
