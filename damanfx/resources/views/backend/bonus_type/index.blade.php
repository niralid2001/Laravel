        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="@if(isset($record)){{ route('admin_bonus-type-update', array('id' => Crypt::encrypt($record->id))) }}@else{{route('admin_bonus-type-store')}}@endif" id="bonus-type-form" enctype="multipart/form-data" data-parsley-validate="">
                            ...
                            <a href="{{route('admin_bonus-types')}}" class="btn btn-danger">{{__('Cancel')}}</a>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            var page = $("#tplatforms").DataTable({
                    ...
                    "ajax" : {
                        url : "{{ route('admin_bonus-type-datatable') }}",
                        type : "POST",
                        data : function(d) {
                            d._token = "{{ csrf_token() }}"
                        }
            ...
            $(document).on('click', '.delete', function() {
                ...
                swal({
                    title: "",
                    text: "{{__('Are you sure? Delete this bonus type!')}}",
                    type: "warning",
