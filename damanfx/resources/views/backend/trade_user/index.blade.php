        ...
        $(document).ready(function() {
            var page = $("#subscriber").DataTable({
                    ...
                    "columns": [
                        ...
                        {data: 'investment_capital', name: 'investment_capital'},
                        {data: 'action', name: 'action', orderable: false, searchable: false},
                    ],
                    "ajax" : {
                        url : "{{ route('admin_trade-users-datatable') }}",
                        type : "POST",
                        data : function(d) {
                            d._token = "{{ csrf_token() }}"
                        }
            ...
            $(document).on('click', '.delete', function() {
                ...
                swal({
                    title: "",
                    text: "{{__('Are you sure? Delete this trade user!')}}",
                    type: "warning",
