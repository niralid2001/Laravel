                    ...
                    <div class="card-header">
                        <div class="form-row">
                            <div class="col-md-12 text-right">
                                <div class="col-md-12 text-right"><a href="{{route('admin_broker-faq-create', array($broker_id))}}" class="btn btn-success"><i class="align-middle" data-feather="plus"></i>{{__('Add')}}</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            var page = $("#faq").DataTable({
                    ...
                    "ajax" : {
                        url : "{{ route('admin_broker-faq-datatable') }}",
                        type : "POST",
                        data : function(d) {
                            d._token = "{{ csrf_token() }}",
