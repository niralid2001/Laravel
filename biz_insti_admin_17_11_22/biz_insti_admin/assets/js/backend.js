$(document).ready(function() {
    ...
    var dataTableObj_sd = $('.server_datatable').DataTable({
        searching: true,
        processing: true,
	 ...
	 var dataTableObj = $('#student_csv').DataTable({
        searching: true,
        processing: true,
        dom: 'Bfrtip',
        buttons: [
            //'excel'
			{
				extend: 'excel', "text":'Download Student Data',"className": 'btn btn-success btn-xs',
                exportOptions: {
        ...
        ajax: {
            "url": base_url + $('#student_csv').attr('data-url'),
            "type": "POST"
        },
        initComplete: function(settings, json) {
	...
	$('#outtime').timepicker({ 'timeFormat': 'H:i:s' });
...
$(document).on('submit', '#add_lead_management', function() {
    // $('.addNewLeadManagement').trigger('click');
    // console.log('submit');return false;
});

    setTimeout(function () {
        	$(document).on('click', '.addNewLeadManagement', function() {
                var formdata = new FormData($('#add_lead_management')[0]);
                var type = $(this).attr('data-type');
                
                var valid_check = 'valid';
        		
                //var student_name = $('#add_lead_management input[name="name"]').val();
        		var lead_name = $('#add_lead_management input[name="name"]').val();
                ...
                if (valid_check == 'valid') {
                    ...
                    $.ajax({
                        method: "POST",
                        url: base_url + "ajaxcall/addLeadManagement",
                        data: formdata,
                        processData: false,
                        contentType: false,
                        success: function(resp) {
                            ...
                            if (resp['status'] == '1') {
                                ...
                                if (type == 'add') {
                                    /*if (resp['enroll_id'] != '' && resp['password'] != '') {
                                        $('#add_lead_management').html('<div class="enrollmentDetails text-center"><p >' + ltr_password_student_msg + '<b> ' + student_name + '</b> is </p><h5 class="padderTop20">' + ltr_enrollment_id + ' : ' + resp['enroll_id'] + '</h5><h5 class="padderBottom20">' + ltr_password + ' : ' + resp['password'] + '</h5><a href="' + base_url + 'admin/add-student" class="btn btn-primary">' + ltr_add_another_student + '</a></div>');
                                    }*/
        							 window.location.href = base_url + 'admin/lead_management';
                                     // location.reload();
                                } else {
                                    // setTimeout(function() {
                                        window.location.href = base_url + 'admin/lead_management';
	...
	$(document).on('submit', '#add_enquiry', function() {
        var formdata = new FormData($('#add_enquiry')[0]);
        var type = $(this).attr('data-type');
        var valid_check = 'valid';
		
        var lead_name = $('#add_enquiry input[name="name"]').val();
        ...
        if (valid_check == 'valid') {
            ...
            $.ajax({
                method: "POST",
                url: base_url + "ajaxcall/addEnquiry",
                data: formdata,
                processData: false,
                contentType: false,
                success: function(resp) {
	...
	$(document).on('submit', '#add_visitors', function() {
		var formdata = new FormData($('#add_visitors')[0]);
        var type = $(this).attr('data-type');
        var valid_check = 'valid';
		
        var name = $('#add_visitors input[v_name="v_name"]').val();
        ...
        if (valid_check == 'valid') {
            ...
            $.ajax({
                method: "POST",
                url: base_url + "ajaxcall/addVisitors",
                data: formdata,
                processData: false,
                contentType: false,
                success: function(resp) {
                    ...
                    if (resp['status'] == '1') {
                        ...
                        if (type == 'add') {
							 ...
							 window.location.href = base_url + 'admin/visitors';
                        } else {
                            setTimeout(function() {
                                window.location.href = base_url + 'admin/visitors';
                                //location.reload();
	...
	$(document).on('submit', '#add_call_log', function() {
		var formdata = new FormData($('#add_call_log')[0]);
        var type = $(this).attr('data-type');
        var valid_check = 'valid';
		
        var name = $('#add_call_log input[name="name"]').val();
        ...
        if (valid_check == 'valid') {
            ...
            $.ajax({
                method: "POST",
                url: base_url + "ajaxcall/addCallLog",
                data: formdata,
                processData: false,
                contentType: false,
				success: function(resp) {
                    ...
                    if (resp['status'] == '1') {
                        ...
                        if (type == 'add') {
							 ...
							 window.location.href = base_url + 'admin/call_log';
                        } else {
                            setTimeout(function() {
                                window.location.href = base_url + 'admin/call_log';
                                //location.reload();
	...
	$(document).on('click', '.searchCriteriaLeadManagement', function(e) {
        e.preventDefault();
		selectElement = document.querySelector('#search_cr');
		s_source = selectElement.value;
		var s_fromdate = document.getElementById("fromdate").value;
		var s_todate = document.getElementById("todate").value;
		
		selectElement_a = document.querySelector('#status');
		s_status = selectElement_a.value;
		dataTableObj_sd.ajax.url(base_url + 'ajaxcall/lead_management_table' + '?s_source=' + s_source+ '&s_fromdate=' + s_fromdate+ '&s_todate=' + s_todate+ '&s_status=' + s_status).load();
	...
	$(document).on('click', '.addplacement', function() {
		//alert("hii");exit;
        var word = $(this).attr('data-word');
		var id = $(this).data('id');
        var title = $(this).attr('data-title');
        ...
        $.magnificPopup.open({
            items: {
                src: '#placementViewPopup',
            },
            type: 'inline'
        });
    });
	
	$(document).on('click', '.addstudentplacement', function() {
        var formdata = new FormData($('#add_student_placement')[0]);
        ...
        if (valid_check == 'valid') {
            ...
            $.ajax({
                method: "POST",
                url: base_url + "ajaxcall/addPlacementTracker",
                data: formdata,
                processData: false,
                contentType: false,
                success: function(resp) {
                    ...
                    if (resp['status'] == '1') {
                        ...
                        if (type == 'add') {
							 ...
							 window.location.href = base_url + 'admin/placement-tracker';
                        } else {
                            setTimeout(function() {
                                window.location.href = base_url + 'admin/placement-tracker';
                                //location.reload();
    ...
    $(document).on('click', '.changeStatusButton', function() {
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    if (resp['status'] == '1') {
                        ...
                        dataTableObj.ajax.url(base_url + targetTableUrl).load();
                        if(status==0){
                            thisObj.removeClass('light_sky_bg').addClass('light_red_bg').html('Inactive').attr('data-status',1);
                        } else {
                            thisObj.removeClass('light_red_bg').addClass('light_sky_bg').html('Active').attr('data-status',0);
                        }
                    } else {
                        toastr.error(ltr_something_msg);
                    }
        ...
        var id = $(this).attr('data-id');
        //console.log(id); return false;
        //alert(id);wvar id = $(this).attr('data-id');
        //console.log(id); return false;
        //alert(id);            $(".checkOneRow").prop("checked", false);
                    $(".checkAllAttendance").prop("checked", false);
                },
                error: function(resp) {
                    toastr.error(ltr_something_msg);
