$(document).ready(function() {
    ...
    var dataTableObj = $('.server_datatable')+({
        searching: true,
        processing: true,
	...
	$(document).on('click', '.addNewEnquiry', function() {
	...
	$(document).on('click', '.addNewVisitors', function() {
	...
	$(document).on('click', '.addNewCalllog', function() {
	...
	$(document).on('click', '.searchCriteriaLeadManagement', function() {
		...
		dataTableObj.ajax.url(base_url + 'ajaxcall/lead_management_table' + '?s_source=' + s_source+ '&s_fromdate=' + s_fromdate+ '&s_todate=' + s_todate+ '&s_status=' + s_status).load();
