		...
		function __construct(){
			...
			$front_details = $this->CI->db_model->select_data('email','frontend_details',array('id'=>1),1);
				if(!empty($site_details)){
                    ...
                    $siteTitle = ($site_details[0]['site_title']!='')?$site_details[0]['site_title']:'Biz Academy';
                    $authorName = ($site_details[0]['site_author']!='')?$site_details[0]['site_author']:'Biz Academy';
                    $desccription = ($site_details[0]['site_description']!='')?$site_details[0]['site_description']:'Biz Academy';
                    $keyword = ($site_details[0]['site_keywords']!='')?$site_details[0]['site_keywords']:'Biz Academy';
                    $enrol_word = ($site_details[0]['enrollment_word']!='')?$site_details[0]['enrollment_word']:'ACAD';
                    $copyright = ($site_details[0]['copyright_text']!='')?$site_details[0]['copyright_text']:'Copyright &copy; 2020 Biz Academy. All Right Reserved.';
