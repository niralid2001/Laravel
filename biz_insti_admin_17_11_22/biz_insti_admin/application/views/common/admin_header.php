                ...
                <?php
                    ...
                    <li class="has_sub_menu <?php echo (in_array("add-student",$cur_arr) || in_array("student-manage",$cur_arr) || in_array("manage-student-leave",$cur_arr))?'active':''; ?>"><a href="javascript:void(0);">
                        ...
                        <ul class="sub-menu">
							...
							<li <?php echo (in_array("placement-tracker",$cur_arr))?'class="active"':''; ?>><a href="<?php echo base_url();?>admin/placement-tracker"><?php echo html_escape($this->common->languageTranslator('ltr_placement_tracker'));?></a></li>
                        </ul>
                    </li>

                    <!-- lead_management -->
                    <?php }} if(isset($access->lead_management) || $this->session->userdata['super_admin']==1){
                    if($access->lead_management == '1' || $this->session->userdata['super_admin']==1){ ?>
                    <li class="has_sub_menu <?php echo (in_array("add-lead_management",$cur_arr) || in_array("lead_management",$cur_arr))?'active':''; ?>"><a href="javascript:void(0);">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 30 30" enable-background="new 0 0 30 30" xml:space="preserve">
                            <g>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.489,22.06c0.063-0.261,0.107-0.525,0.189-0.78
                        ...
                        <span><?php echo html_escape($this->common->languageTranslator('ltr_lead_management'));?></span>
                        </a>
                        <ul class="sub-menu">
                            <li <?php echo (in_array("add-lead_management",$cur_arr))?'class="active"':''; ?>><a href="<?php echo base_url();?>admin/add_lead_management"><?php echo html_escape($this->common->languageTranslator('ltr_add_lead_management'));?></a></li>
							<li <?php echo (in_array("lead_management",$cur_arr) || in_array("doubts-ask",$cur_arr))?'class="active"':''; ?>><a href="<?php echo base_url();?>admin/lead_management"><?php echo html_escape($this->common->languageTranslator('ltr_lead_management'));?></a></li>
                        </ul>
                    </li>
					
					<!-- visitor panel -->
					<?php }} if(isset($access->visitor) || $this->session->userdata['super_admin']==1){
                    if($access->visitor == '1' || $this->session->userdata['super_admin']==1){ ?>
                    <li class="has_sub_menu <?php echo (in_array("add-visitor",$cur_arr) || in_array("visitor",$cur_arr))?'active':''; ?>"><a href="javascript:void(0);">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 30 30" enable-background="new 0 0 30 30" xml:space="preserve">
                            <g>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.489,22.06c0.063-0.261,0.107-0.525,0.189-0.78
                        ...
                        <span><?php echo html_escape($this->common->languageTranslator('ltr_visitors'));?></span>
                        </a>
                        <ul class="sub-menu">
                            <li <?php echo (in_array("visitors",$cur_arr) || in_array("doubts-ask",$cur_arr))?'class="active"':''; ?>><a href="<?php echo base_url();?>admin/visitors"><?php echo html_escape($this->common->languageTranslator('ltr_visitors'));?></a></li>
                        </ul>
                    </li>
					
					<!-- Phone Call Log -->
					<?php }} if(isset($access->call_log) || $this->session->userdata['super_admin']==1){
                    if($access->call_log == '1' || $this->session->userdata['super_admin']==1){ ?>
                    <li class="has_sub_menu <?php echo (in_array("add-call_log",$cur_arr) || in_array("call_log",$cur_arr))?'active':''; ?>"><a href="javascript:void(0);">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 30 30" enable-background="new 0 0 30 30" xml:space="preserve">
                            <g>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.489,22.06c0.063-0.261,0.107-0.525,0.189-0.78
                        ...
                        <span><?php echo html_escape($this->common->languageTranslator('ltr_call_log'));?></span>
                        </a>
                        <ul class="sub-menu">
                            <li <?php echo (in_array("call_log",$cur_arr) || in_array("doubts-ask",$cur_arr))?'class="active"':''; ?>><a href="<?php echo base_url();?>admin/call_log"><?php echo html_escape($this->common->languageTranslator('ltr_call_log'));?></a></li>
                        </ul>
                    </li>
            ...
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <li class="has_sub_menu <?php echo (in_array("general-settings",$cur_arr))?'active':''; ?>"><a href="javascript:void(0);">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li style="display:none" <?php echo (in_array("language-settings",$cur_arr))?'class="active"':''; ?>><a href="<?php echo base_url();?>admin/language-settings"><?php echo html_escape($this->common->languageTranslator('ltr_language_settings'));?></a></li>
