...
<section class="edu_admin_content">
    <div class="edu_admin_right sectionHolder edu_add_users">
        <div class="edu_admin_informationdiv edu_main_wrapper edu_add_student_wrapper">
            <form class="form" id="add_lead_management" method="post" enctype="multipart/form-data" autocomplete="off" >
                <div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group"> 
                            ...
                            <select class="form-control require edu_selectbox_with_search" name="source" data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_source'));?>">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group"> 
                            ...
                            <span class="select-date">
                                <input type="text" class="form-control chooseDate require" name="enquiry_date" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_enquiry_date'));?>" value="<?php echo !empty($lead_management_data)?date('d-m-Y',strtotime($lead_management_data[0]['enquiry_date'])):'';?>">
                            </span> 
                        </div>
                    </div>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group"> 
                            ...
                            <span class="select-date">
                                <input type="text" class="form-control chooseDate require" name="enquiry_fromdate" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_enquiry_lastfollowdate'));?>" value="<?php echo !empty($lead_management_data)?date('d-m-Y',strtotime($lead_management_data[0]['enquiry_fromdate'])):'';?>">
                            </span> 
                        </div>
                    </div>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group"> 
                            ...
                            <span class="select-date">
                                <input type="text" class="form-control chooseDate require" name="enquiry_todate" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_enquiry_nextfollowtodate'));?>" value="<?php echo !empty($lead_management_data)?date('d-m-Y',strtotime($lead_management_data[0]['enquiry_todate'])):'';?>">
                            </span> 
						</div>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                    <input type="button" value="<?php echo !empty($lead_management_data)? $ltr_update_lead_management : $ltr_add_lead_management ;?>" class="edu_admin_btn addNewLeadManagement" data-type="<?php echo html_escape($type);?>" />
                </div>
