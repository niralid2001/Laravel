                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                               <div class="form-group"> 
		                            ...
		                            <select id="search_cr" class="form-control require edu_selectbox_with_search" name="gender" data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_source'));?>">
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group"> 
                                	<span>
                                       	<input type="button" value="<?php echo html_escape($this->common->languageTranslator('ltr_search'));?>" class="btn btn-primary searchCriteriaLeadManagement"> 
					                <span>
                                </div>
                            </div>
