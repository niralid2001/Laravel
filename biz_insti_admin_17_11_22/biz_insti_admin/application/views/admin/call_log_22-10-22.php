	...
	<div class="edu_admin_right sectionHolder edu_student_manager">
	    <div class="edu_table_wrapper sectionHolder">
			<div class="edu_admin_informationdiv">
                <form class="form" id="add_call_log" method="post" enctype="multipart/form-data" autocomplete="off" >
							...
							<div class="col-4">
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group"> 
										...
										<input type="text" class="form-control require alphaField" name="name" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_name'));?>" value="<?php echo !empty($record)?$record[0]['name']:'';?>" required>
									</div>
								</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group"> 
										...
										<input type="text" class="form-control require" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_phone'));?>"  name="phone" maxlength="12" value="<?php echo !empty($record)?$record[0]['phone']:'';?>" data-valid="mobile" data-error="<?php echo html_escape($this->common->languageTranslator('ltr_valid_contact_msg'));?>" required>
									</div>
								</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group"> 
										...
										<textarea name="description" rows="2" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_description'));?>" class="form-control"><?php echo !empty($record)?$record[0]['description']:'';?></textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group"> 
										...
										<textarea name="note" rows="2" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_note'));?>" class="form-control"><?php echo !empty($record)?$record[0]['note']:'';?></textarea>
									</div>
								</div>
								...
								<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
									<div class="form-group"> 
										<span>
											<input type="button" value="<?php echo html_escape($this->common->languageTranslator('ltr_addcalllog'));?>" class="btn btn-primary addNewCalllog"> 
										<span>
									</div>
								</div>
                            </div>
