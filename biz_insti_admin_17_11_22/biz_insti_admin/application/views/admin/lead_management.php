                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                               <div class="form-group"> 
		                            ...
		                            <select id="search_cr" class="form-control  edu_selectbox_with_search" name="gender" data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_source'));?>">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group"> 
		                            ...
		                            <span class="select-date">
		                                <input id="fromdate" type="text" class="form-control chooseDate require" name="enquiry_fromdate" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_enquiry_fromdate'));?>" value="<?php echo !empty($student_data)?date('d-m-Y',strtotime($student_data[0]['enquiry_fromdate'])):'';?>">
		                            </span> 
		                        </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group"> 
		                            ...
		                            <span class="select-date">
		                                <input id="todate" type="text" class="form-control chooseDate require" name="enquiry_todate" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_enquiry_todate'));?>" value="<?php echo !empty($student_data)?date('d-m-Y',strtotime($student_data[0]['enquiry_todate'])):'';?>">
		                            </span> 
		                        </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group"> 
		                            ...
		                            <select id="status" class="form-control require edu_selectbox_with_search" name="status" data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_status'));?>">
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group"> 
                                	<span>
                                       	<input type="submit" value="<?php echo html_escape($this->common->languageTranslator('ltr_search'));?>" class="btn btn-primary searchCriteriaLeadManagement"> 
					                <span>
                                </div>
                            </div>
			    ...
			    echo '<section class="edu_admin_content">
                        <div class="edu_admin_right sectionHolder edu_add_users">
                            <div class="edu_admin_informationdiv edu_main_wrapper">
                                <div class="eac_text eac_page_re">'.html_escape($this->common->languageTranslator('ltr_lead_manage_no_data')).'</div>
                            </div>
                        </div>
                    </section>';
			}
