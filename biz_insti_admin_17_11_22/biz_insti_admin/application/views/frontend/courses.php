		...
		<section class="edu_courses_wrapper">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 padder0">
						<div class="edu_courses_section">
							...
							?>
            					...
            					<!--	<div class="edu_courses_box">-->
            					<!--		<div class="edu_courses_imgbox">-->
            					<!--		    <img src="http://bizzonit.com/ci/biz-academy_test/assets/images/course01.jpg" alt="image">-->
                	...
                	<!--					        <li><img src="http://bizzonit.com/ci/biz-academy_test/assets/images/star.svg" alt="image"></li>-->
                	<!--					        <li><img src="http://bizzonit.com/ci/biz-academy_test/assets/images/star.svg" alt="image"></li>-->
                	<!--					        <li><img src="http://bizzonit.com/ci/biz-academy_test/assets/images/star.svg" alt="image"></li>-->
                	<!--					        <li><img src="http://bizzonit.com/ci/biz-academy_test/assets/images/blank_star.svg" alt="image"></li>-->
                	<!--					        <li><img src="http://bizzonit.com/ci/biz-academy_test/assets/images/blank_star.svg" alt="image"></li>-->
                	<!--					        <li><img src="http://bizzonit.com/ci/biz-academy_test/assets/images/blank_star.svg" alt="image"></li>-->
                	<!--					    </ul>-->
