				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-12">
						<div class="edu_about_detail mb_30">
							<h4 class="edu_subTitle"><?php $hh = html_escape($this->common->languageTranslator('ltr_about_bizacademy')); echo !empty($frontend_details[0]['abt_frst_sub_heading'])?$frontend_details[0]['abt_frst_sub_heading']: $hh;?></h4>
		...
		<section class="edu_testimonial_wrapper">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
						<div class="edu_heading_wrapper">
							<h4 class="edu_subTitle"><?php echo !empty($frontend_details[0]['testi_subheading'])?$frontend_details[0]['testi_subheading']:'Biz- Academy Reviews';?></h4>
