...
$route['admin/add-enquiry'] = 'admin_profile/add_enquiry';
$route['admin/add-enquiry/(:any)'] = 'admin_profile/add_enquiry/$1';
$route['admin/add_lead_management'] = 'admin_profile/add_lead_management';
$route['admin/add_lead_management/(:any)'] = 'admin_profile/add_lead_management/$1';
$route['admin/lead_management'] = 'admin_profile/lead_management';
$route['admin/visitors'] = 'admin_profile/visitors';
$route['admin/visitors/(:any)'] = 'admin_profile/visitors/$1';
$route['admin/call_log'] = 'admin_profile/call_log';
$route['admin/call_log/(:any)'] = 'admin_profile/call_log/$1';
...
$route['admin/placement-tracker'] = 'admin_profile/placement_tracker';
$route['admin/student-placement/(:any)'] = 'admin_profile/student_placement/$1';
