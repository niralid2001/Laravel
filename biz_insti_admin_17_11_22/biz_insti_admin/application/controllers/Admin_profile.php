...
// 		die();
	...
	function add_enquiry($id=''){
		$header['title']=$this->lang->line('ltr_add_enquiry');
		$data['enquiryt_id'] = $id;
		//echo $id;exit;
		...
		if(!empty($id)){
			...
			$data['enquiry_data'] = $result;
			$header['title']=$this->lang->line('ltr_edit_enquiry');
		}else{
			$header['title']=$this->lang->line('ltr_add_enquiry');
		}
		...
		$data['enquiry'] = $this->db_model->select_data('id','enquiry use index (id)');
	...
	function add_lead_management($id=''){
		$header['title']=$this->lang->line('ltr_add_lead_management');
		$data['student_lead_management_id'] = $id;
		//echo $id;exit;
		
		if(!empty($id)){
			$this->db->select('student_lead_management.*, name, contact','source')
			 ->from('student_lead_management')
			 ->where('student_lead_management.id',$id);
			 // ->join('students', 'student_lead_management.student_id = students.id');
			//print_r($this->db->last_query());exit;
			$result = $this->db->get()->result_array();
			$data['lead_management_data'] = $result;
			$header['title']=$this->lang->line('ltr_edit_lead_management');
		}else{
			$header['title']=$this->lang->line('ltr_add_lead_management');
		}
		...
		$data['students'] = $this->db_model->select_data('*','students use index (id)');
		//print_r($this->db->last_query());exit;
		$data['lead_management'] = $this->db_model->select_data('id','student_lead_management use index (id)');
		
		$this->load->view("common/admin_header",$header);
		$this->load->view("admin/add_lead_management",$data); 
		$this->load->view("common/admin_footer");
	}

	function lead_management(){
		$header['title']=$this->lang->line('ltr_lead_management');
		$this->load->view("common/admin_header",$header);
		// $data['lead_management_data'] = $this->db_model->select_data('e.*,','student_lead_management');

		$query=$this->db->select('student_lead_management.*, students.name, students.contact_no')
         ->from('student_lead_management')
         ->join('students', 'student_lead_management.student_id = students.id');
         $result = $this->db->get()->result_array();
         $data['lead_management_data'] = $result;
          //print_r($result);exit;
		$this->load->view("admin/lead_management",$data); 
		$this->load->view("common/admin_footer");
	}
	...
	function visitors($id=''){
		...
		$header['title']=$this->lang->line('ltr_visitors');
		...
		if(!empty($id)){
			$this->db->select('visitors.*')
			 ...
			 $result = $this->db->get()->result_array();
			 $data['record'] = $result;
			$header['title']=$this->lang->line('ltr_edit_visitors');
		}else{
			$header['title']=$this->lang->line('ltr_add_visitors');
		}
	...
	function call_log($id=''){
		//print_r("hii");exit;
		$header['title']=$this->lang->line('ltr_call_log');
		...
		if(!empty($id)){
			$this->db->select('call_log.*')
			 ...
			 $result = $this->db->get()->result_array();
			 $data['record'] = $result;
			$header['title']=$this->lang->line('ltr_edit_call_log');
		}else{
			$header['title']=$this->lang->line('ltr_add_call_log');
		}
		...
		$this->load->view("common/admin_header",$header);
		$this->load->view("admin/call_log",$data); 
		$this->load->view("common/admin_footer");
	}
	...
	function placement_tracker(){
	    $header['title']=$this->lang->line('ltr_placement_tracker');	
		$data['student_data'] = $this->db_model->select_data('*','students');
		$data['batches'] = $this->db_model->select_data('*','batches');
		
		$this->load->view("common/admin_header",$header);
		$this->load->view("admin/placement_tracker",$data); 
		$this->load->view("common/admin_footer");
	}
	
	function student_placement($id){
		//echo "hii profile..";exit;
		$data['placement_id'] = $id;
		$header['title']=$this->lang->line('ltr_student_placement');
		if(!empty($id)){
			$data['placement_data'] = $this->db_model->select_data('*','placement');
			$this->load->view("common/admin_header",$header);
			$this->load->view("admin/student_placement",$data); 
			$this->load->view("common/admin_footer");
		}else{
			redirect(base_url('admin/teacher-manage'));
		}
