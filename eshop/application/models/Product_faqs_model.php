    ...
    public function get_faqs()
    {
        ...
        foreach ($rating_search_res as $row) {
            ...
            if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
                ...
                $operate = ' <a href="javascript:void(0)" class="edit_btn btn btn-success btn-xs mr-1 mb-1" title="View" data-id="' . $row['id'] . '" data-url="seller/product_faqs/"><i class="fa fa-edit"></i></a>';
