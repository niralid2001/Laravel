...
<!-- Color CSS -->
<?php /* <link rel="stylesheet" href="<?= THEME_ASSETS_URL . 'css/colors/peach.css' ?>" id="color-switcher"> */ ?>
<link rel="stylesheet" href="<?= THEME_ASSETS_URL . 'css/colors/tufts-blue.css' ?>" id="color-switcher">
