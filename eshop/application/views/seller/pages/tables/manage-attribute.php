                    ...
                    <div class="card content-area p-4">
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="<?= base_url() . 'seller/attributes/' ?>" class="btn btn-block btn-outline-primary btn-sm">Manage Attribute</a>
                            </div>
                        </div>
                        <div class="card-innr">
                            <div class="card-head">
                            ...
                            <table class='table-striped' id='category_table'
                                ...
                                data-export-options='{"fileName": "attribute-value-list", "ignoreColumn": ["state"]}'
